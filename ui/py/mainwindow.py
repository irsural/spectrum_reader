...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gnrw_factory_number_label = QtWidgets.QLabel(self.layoutWidget1)
        self.gnrw_factory_number_label.setText("")
        self.gnrw_factory_number_label.setObjectName("gnrw_factory_number_label")
        self.horizontalLayout_7.addWidget(self.gnrw_factory_number_label)
        self.gnrw_status_label = QtWidgets.QLabel(self.layoutWidget1)
        self.gnrw_status_label.setText("")
        self.gnrw_status_label.setObjectName("gnrw_status_label")
        self.horizontalLayout_7.addWidget(self.gnrw_status_label)
        ...
        self.gridLayout_2.addWidget(self.send_cmd_button, 9, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.cmd_description_text_edit, 6, 0, 2, 2)
        self.sa_connect_button = QtWidgets.QPushButton(self.layoutWidget1)
        self.sa_connect_button.setObjectName("sa_connect_button")
        self.gridLayout_2.addWidget(self.sa_connect_button, 1, 1, 1, 1)
        self.gnrw_ip_edit = QtWidgets.QLineEdit(self.layoutWidget1)
        self.gnrw_ip_edit.setObjectName("gnrw_ip_edit")
        self.gridLayout_2.addWidget(self.gnrw_ip_edit, 3, 0, 1, 1)
        self.cmd_edit = QtWidgets.QLineEdit(self.layoutWidget1)
        self.cmd_edit.setObjectName("cmd_edit")
        self.gridLayout_2.addWidget(self.cmd_edit, 9, 0, 1, 1)
        self.gnrw_connect_button = QtWidgets.QPushButton(self.layoutWidget1)
        self.gnrw_connect_button.setObjectName("gnrw_connect_button")
        self.gridLayout_2.addWidget(self.gnrw_connect_button, 3, 1, 1, 1)
        self.sa_ip_edit = QtWidgets.QLineEdit(self.layoutWidget1)
        self.sa_ip_edit.setObjectName("sa_ip_edit")
        self.gridLayout_2.addWidget(self.sa_ip_edit, 1, 0, 1, 1)
        ...
        self.gridLayout_2.addLayout(self.horizontalLayout_5, 10, 0, 1, 2)
        ...
        self.log_scale_checkbox = QtWidgets.QCheckBox(self.layoutWidget1)
        self.log_scale_checkbox.setObjectName("log_scale_checkbox")
        self.horizontalLayout_6.addWidget(self.log_scale_checkbox)
        self.csv_import_button = QtWidgets.QPushButton(self.layoutWidget1)
        self.csv_import_button.setObjectName("csv_import_button")
        self.horizontalLayout_6.addWidget(self.csv_import_button)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_5.setText(_translate("MainWindow", "IP-адрес Покрова"))
        ...
        self.sa_ip_edit.setText(_translate("MainWindow", "192.168.0.91"))
