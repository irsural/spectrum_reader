...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.mw_splitter_1 = QtWidgets.QSplitter(self.verticalLayoutWidget)
        self.mw_splitter_1.setOrientation(QtCore.Qt.Vertical)
        self.mw_splitter_1.setObjectName("mw_splitter_1")
        self.horizontalLayoutWidget = QtWidgets.QWidget(self.mw_splitter_1)
        ...
        self.read_specter_button = QtWidgets.QPushButton(self.horizontalLayoutWidget)
        self.read_specter_button.setObjectName("read_specter_button")
        self.verticalLayout.addWidget(self.read_specter_button)
        ...
        self.verticalLayout_3.addWidget(self.mw_splitter_1)
        self.gridLayout.addWidget(self.mw_splitter_2, 0, 0, 1, 1)
        MainWindow.setCentralWidget(self.centralWidget)
        self.menuBar = QtWidgets.QMenuBar(MainWindow)
        self.menuBar.setGeometry(QtCore.QRect(0, 0, 633, 19))
        font = QtGui.QFont()
        font.setPointSize(8)
