...
def get_ini_settings():
    return QtSettings("./settings.ini", [
        ...
        QtSettings.VariableInfo(a_name="save_file_name", a_section="PARAMETERS", a_type=QtSettings.ValueType.STRING),
        QtSettings.VariableInfo(a_name="measure_comment", a_section="PARAMETERS", a_type=QtSettings.ValueType.STRING),
